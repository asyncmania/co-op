...
use Modules\Members\Repositories\EloquentMember;
...
class MembersServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        AliasLoader::getInstance()->alias(
            'Members',
            'Modules\Members\Facades\Facade'
        );

        /*Member::observe(new SlugObserver());
        Member::observe(new FileObserver());*/
    ...
    public function register()
    {
        ...
        $app->bind('Modules\Members\Repositories\MemberInterface', function (Application $app) {
            $repository = new EloquentMember(new Member);
            return $repository;
        });

        /*$app->view->composer('members::public.*', function ($view) {
            $view->page = \MyApp::getPageLinkedToModule('members');
        });*/
    }
