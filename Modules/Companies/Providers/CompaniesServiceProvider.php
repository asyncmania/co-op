...
use Modules\Companies\Repositories\EloquentCompany;
...
class CompaniesServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        AliasLoader::getInstance()->alias(
            'Companies',
            'Modules\Companies\Facades\Facade'
        );

        /*Company::observe(new SlugObserver());
    ...
    public function register()
    {
        ...
        $app->bind('Modules\Companies\Repositories\CompanyInterface', function (Application $app) {
            $repository = new EloquentCompany(new Company);
            return $repository;
        });

        /*$app->view->composer('companies::public.*', function ($view) {
            $view->page = \MyApp::getPageLinkedToModule('companies');
        });*/
    }
