<div class="modal fade" id="exampleModalLong" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            {{Form::open(['route'=>"admin.{$module}.bulk_upload",'files'=>true])}}
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {{Form::text('start_date',null,['class'=>'form-control date-picker'])}}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="name" class="control-label">End Date</label>
                            {{Form::text('end_date',null,['class'=>'form-control date-picker'])}}
                        </div>
                    </div>
                </div>
                <div class="form-group">
